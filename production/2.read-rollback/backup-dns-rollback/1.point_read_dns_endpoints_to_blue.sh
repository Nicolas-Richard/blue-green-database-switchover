  ...
  "Changes": [
    {
      ...
      "ResourceRecordSet": {
        ...
        "ResourceRecords": [
          {
            "Value": "blue-cluster-batch.cluster-custom-yyyyyyyyyyyyyy.us-east-1.rds.amazonaws.com"
          }
        ]
      }
    }
  ...
  "Changes": [
    {
      ...
      "ResourceRecordSet": {
        ...
        "ResourceRecords": [
          {
            "Value": "blue-cluster-live.cluster-custom-yyyyyyyyyyyyyy.us-east-1.rds.amazonaws.com"
          }
        ]
      }
    }
